...
<body>
	...
	<div class="container">
		<form action="" method="POST">
			...
			<p><label for="year">Ваш год рождения</label>
			...
			<p><label <?php if(!empty($errors['gender'])) print 'class="error_check"'?>>Ваш пол:</label>
			<input type="radio" id="male" value="male" name="gender" <?php if (isset($values['gender'])&&$values['gender'] == 'male') print("checked"); ?>>Муж
			<input type="radio" id="female" value="female" name="gender" <?php if (isset($values['gender'])&&$values['gender'] == 'female') print("checked"); ?>>Жен</p>

			<p><label <?php if(isset($_COOKIE['kon_error'])) print 'class="error_check"'?>>Кол-во ваших конечностей:</label>
